...
Computadora::Computadora(float velProcesador, int nucProcesador, int capMemoria, int capDisco)
            : procesador(velProcesador, nucProcesador), memoria(capMemoria), disco(capDisco), periferico(nullptr) {}
...
void Computadora::encender() 
    {
        ...
        // Demuestra funcionamiento de componentes.
        ...
        // Conecta los periféricos si existen.
...
void Computadora::apagar() 
    {
        ...
        // Desconecta los periférico si existen (SOLO desconecta, NO borra).
        if (periferico != nullptr) 
            {
        ...
        if (periferico != nullptr) 
            {
                ...
                // NO hacer delete aquí - el main se encarga de la memoria.
                periferico = nullptr;
            }
    }